...
const translations = {
  es: {
    ...
    servicesLead: "Hoy día mi trabajo se divide en dos enfoques, según la necesidad del negocio. Por un lado, en proyectos puntuales donde me enfoco en la implementación y análisis de datos para aportar claridad y mejorar la toma de decisiones. Por otro, cuando el alcance es mayor, participo en soluciones más integrales, acompañando el análisis con seguimiento, control y coordinación de la operativa.",
    service1Title: "Servicio profesional independiente",
    service1Text: "Implementación y ejecución de análisis de datos, construcción de indicadores y desarrollo de dashboards orientados a entender la operación y mejorar la toma de decisiones.",
    service1Text2: "Enfocado en generar claridad sobre el negocio a partir de información concreta.",
    service2Title: "Solución integral | Bidata",
    service2Text: "Cuando el proyecto requiere una solución más amplia, participo en la coordinación y seguimiento de la operativa, integrando análisis, control y toma de decisiones.",
    service2Text2: "Trabajo en conjunto con distintos perfiles (analistas, desarrolladores, sistemas) asegurando coherencia, dirección y cumplimiento de los objetivos del negocio.",
  ...
  en: {
    ...
    servicesLead: "My work is currently divided into two approaches depending on business needs. On one hand, I focus on specific projects involving data implementation and analysis to bring clarity and improve decision-making. On the other hand, when the scope is broader, I take part in more comprehensive solutions, combining analysis with monitoring, control, and operational coordination.",
    service1Title: "Independent professional service",
    service1Text: "Implementation and execution of data analysis, KPI development, and dashboard creation aimed at understanding operations and improving decision-making.",
    service1Text2: "Focused on bringing clarity to the business through concrete information.",
    service2Title: "Integrated solution | Bidata",
    service2Text: "When the project requires a broader solution, I participate in coordinating and monitoring operations, integrating analysis, control, and decision-making.",
    service2Text2: "I work alongside different profiles — analysts, developers, and systems specialists — ensuring coherence, direction, and achievement of business objectives.",
    knowMore: "Learn more →",
